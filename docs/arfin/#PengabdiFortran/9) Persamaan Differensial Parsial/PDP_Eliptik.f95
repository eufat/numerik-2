	...
	! Nilai batas
	x(0)  = 0		!xmin	!###### GANTI WEY ######!
	x(Nx) = 1	!xmax	!###### GANTI WEY ######!
	y(0)  = 0		!ymin	!###### GANTI WEY ######!
	...
	do i=0,Nx
		...
		psi(i,Ny,:) = 1	!func(x, ymax)	!###### GANTI WEY ######!
	end do
	do i = 0,Ny
		psi(0,i,:)  = -1				!func(xmin, y)	!###### GANTI WEY ######!
		psi(Nx,i,:) =-1	!func(xmax, y)	!###### GANTI WEY ######!
	end do
	...
	open(unit=10, file = 'PDP-Eliptik.dat', status='unknown')
	do i=0,Nx
		do j=0,Ny

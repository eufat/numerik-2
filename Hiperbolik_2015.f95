...
123	write(*,*) "Masukkan nilai Nx : "
	...
	! Syarat batas
	psi(:,:) = 0.d0 !ini tidak mempengaruhi apa2, cuma inisialisasi bahwa psi mula-mula 0
	psi(0,:) = 0.d0			!nilai psi di batas 0
	psi(Nx,:) = 0.d0		!nilai psi di batas max
	
	do i = 1, Nx-1
		psi(i,0) = 110.*(sin(pi*x(i)/200))
	end do
	
	b(:) = 0.d0		!turunan terhadap t
	...
	open(unit=10, file = 'Hasil_Hiperbolik_2015.txt', status='unknown')
	do i=0,Nx
		do j=0,Nt
	...
	write(*,*) "Proses perhitungan selesai, silakan cek file Hasil_Hiperbolik_2015.txt"

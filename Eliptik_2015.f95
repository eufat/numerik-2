	...
	x(Nx) = 2.d0		!xmax	!###### GANTI WEY ######!
	y(0)  = 0.d0		!ymin	!###### GANTI WEY ######!
	y(Ny) = 1.d0		!ymax	!###### GANTI WEY ######!
	...
	psi(:,:,:) = 0.d0				
	do i=0,Nx
		psi(i,0,:)  = 1.d0				!func(x, ymin)	!###### GANTI WEY ######!
		psi(i,Ny,:) = exp(x(i))				!func(x, ymax)	!###### GANTI WEY ######!
	end do
	do i = 0,Ny
		psi(0,i,:)  = 1.d0				!func(xmin, y)	!###### GANTI WEY ######!
		psi(Nx,i,:) = exp(2*y(i))				!func(xmax, y)	!###### GANTI WEY ######!
	end do
	...
	open(unit=10, file = 'Hasil_Eliptik_2015.txt', status='unknown')
	do i=0,Nx
		do j=0,Ny

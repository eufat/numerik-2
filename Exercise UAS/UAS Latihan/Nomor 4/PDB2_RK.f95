	...
	open(unit=10,file="Hasil_PD2_RK_xy.txt",status="unknown")
	open(unit=20, file="Hasil_PD2_RK_xu.txt", status="unknown")
...
100	write(10,*) x,"                       ",y
	...
	write(*,*) "Data disimpan pada file Hasil_PD2_RK_xy.txt dan Hasil_PD2_RK_xu.txt ."
